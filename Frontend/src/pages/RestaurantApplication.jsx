    ...
    return (
        <div className="app-container">
            ...
            <div className="app-card">
                ...
                <p className="app-subtitle">Register your restaurant and create your owner account</p>

                {actionData?.error && (
                    <div className="app-message error-message">
                        {actionData.error}
                    </div>
                )}
                    ...
                    <section className="form-section">
                        ...
                        <div className="form-field">
                            ...
                            <div className="cuisine-checkboxes">
                                ...
                                <label className="checkbox-item">
                                    <input type="checkbox" name="cuisineType" value="vietnamese" />
...
export async function action({ request }) {
    ...
    // Validation
    if (!data.ownerName || !data.email || !data.password || !data.restaurantName || 
        !data.address || !data.contactNumber || !data.amount) {
