...
async function seed() {
  try {
    ...
    // Update dishes with rest_id based on which restaurant serves them
    for (const rest of createdRestaurants) {
      if (rest.dishes && rest.dishes.length > 0) {
        await Dish.updateMany(
          { _id: { $in: rest.dishes } },
          { $set: { rest_id: rest._id } }
        );
      }
    }
    console.log("✅ Dishes linked to restaurants (rest_id set)");
    ...
    const customers = [
      ...
      },
      {
        name: "customer4",
        username: "customer4",
        img_url: "customer4.jpg",
        email: "customer4@example.com",
        phone: "9876543210",
        emailNotificationsEnabled: true,
        prev_orders: [],
        top_dishes: { "BBQ Ribs": 5, "Grilled Steak": 4, "BBQ Chicken": 3 },
        top_restaurent: { "Sunset Grill": 6, "Tasty Bites": 3 },
        cart: [],
        favourites: [],
      },
      {
        name: "customer5",
        username: "customer5",
        img_url: "customer5.jpg",
        email: "customer5@example.com",
        phone: "9876501234",
        emailNotificationsEnabled: true,
        prev_orders: [],
        top_dishes: { "Margherita Pizza": 4, "Pasta Alfredo": 3, "Cheeseburger": 2 },
        top_restaurent: { "Urban Eats": 5, "Cozy Corner": 2 },
        cart: [{ name: "Margherita Pizza", qty: 1 }],
        favourites: [],
      },
      {
        name: "customer6",
        username: "customer6",
        img_url: "customer6.jpg",
        email: "customer6@example.com",
        phone: "9988776655",
        emailNotificationsEnabled: true,
        prev_orders: [],
        top_dishes: { "Crab Curry": 3, "Prawn Masala": 2, "Lobster Thermidor": 2 },
        top_restaurent: { "Ocean Breeze": 4, "Spice Hub": 2 },
        cart: [],
        favourites: [],
      },
      {
        name: "customer7",
        username: "customer7",
        img_url: "customer7.jpg",
        email: "customer7@example.com",
        phone: "8877665544",
        emailNotificationsEnabled: true,
        prev_orders: [],
        top_dishes: { "Gobi Manchurian": 3, "Hakka Noodles": 4, "Spring Rolls": 2 },
        top_restaurent: { "The Spice Route": 5, "Garden Fresh": 2 },
        cart: [{ name: "Hakka Noodles", qty: 2 }],
        favourites: [],
      },
      {
        name: "customer8",
        username: "customer8",
        img_url: "customer8.jpg",
        email: "customer8@example.com",
        phone: "7766554433",
        emailNotificationsEnabled: true,
        prev_orders: [],
        top_dishes: { "Vegetable Tacos": 3, "Burrito": 4, "Quesadilla": 2 },
        top_restaurent: { "Spicy Fiesta": 5, "Green Garden": 3 },
        cart: [],
        favourites: [],
      },
    ];
    ...
    if (createdCustomers && createdCustomers.length >= 8) {
      ...
      await Person.findByIdAndUpdate(createdCustomers[3]._id, {
        $set: {
          favourites: [
            dishes[36]._id.toString(),
            dishes[37]._id.toString(),
            dishes[14]._id.toString(),
          ],
        },
      });
      await Person.findByIdAndUpdate(createdCustomers[4]._id, {
        $set: {
          favourites: [
            dishes[11]._id.toString(),
            dishes[28]._id.toString(),
            dishes[29]._id.toString(),
          ],
        },
      });
      await Person.findByIdAndUpdate(createdCustomers[5]._id, {
        $set: {
          favourites: [
            dishes[24]._id.toString(),
            dishes[9]._id.toString(),
            dishes[25]._id.toString(),
          ],
        },
      });
      await Person.findByIdAndUpdate(createdCustomers[6]._id, {
        $set: {
          favourites: [
            dishes[32]._id.toString(),
            dishes[33]._id.toString(),
            dishes[46]._id.toString(),
          ],
        },
      });
      await Person.findByIdAndUpdate(createdCustomers[7]._id, {
        $set: {
          favourites: [
            dishes[10]._id.toString(),
            dishes[26]._id.toString(),
            dishes[27]._id.toString(),
          ],
        },
      });
    }
    ...
    // ─── Additional customers reference ───
    const customerD = createdCustomers[3]; // customer4
    const customerE = createdCustomers[4]; // customer5
    const customerF = createdCustomers[5]; // customer6
    const customerG = createdCustomers[6]; // customer7
    const customerH = createdCustomers[7]; // customer8

    // ═══════════════════════════════════════════
    // EXTRA ORDERS: New customers + historical data for trends
    // ═══════════════════════════════════════════

    // --- customer4: BBQ & Grill lover at Sunset Grill (heavy spender) ---
    const customer4Orders = [
      {
        customerName: customerD.name,
        restaurant: sunsetGrill.name,
        rest_id: sunsetGrill._id,
        table_id: "T4",
        dishes: [dishes[36]._id, dishes[37]._id, dishes[14]._id],
        totalAmount: 1500,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "04",
        date: daysAgo(2),
        rating: 5.0,
        orderTime: new Date(daysAgo(2).setHours(19, 0, 0, 0)),
        completionTime: new Date(daysAgo(2).setHours(19, 35, 0, 0)),
        estimatedTime: 30,
        assignedStaff: ["staff11"],
        feedback: "Best BBQ combo ever!",
      },
      {
        customerName: customerD.name,
        restaurant: sunsetGrill.name,
        ...
        date: daysAgo(8),
        rating: 5.0,
        orderTime: new Date(daysAgo(8).setHours(20, 0, 0, 0)),
        completionTime: new Date(daysAgo(8).setHours(20, 40, 0, 0)),
        estimatedTime: 35,
        assignedStaff: ["staff11"],
        feedback: "Ribs are consistently amazing",
      },
      {
        customerName: customerD.name,
        restaurant: sunsetGrill.name,
        rest_id: sunsetGrill._id,
        table_id: "T6",
        dishes: [dishes[37]._id, dishes[14]._id],
        totalAmount: 1000,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "06",
        date: daysAgo(15),
        rating: 4.5,
        orderTime: new Date(daysAgo(15).setHours(18, 30, 0, 0)),
        completionTime: new Date(daysAgo(15).setHours(19, 5, 0, 0)),
        estimatedTime: 30,
        assignedStaff: ["staff11"],
        feedback: "Steak was perfectly cooked",
      },
      {
        customerName: customerD.name,
        restaurant: firstRestaurant.name,
        rest_id: firstRestaurant._id,
        table_id: "T6",
        dishes: [dishes[0]._id, dishes[1]._id, dishes[6]._id],
        totalAmount: 880,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "06",
        date: daysAgo(5),
        rating: 4.5,
        orderTime: new Date(daysAgo(5).setHours(13, 0, 0, 0)),
        completionTime: new Date(daysAgo(5).setHours(13, 25, 0, 0)),
        estimatedTime: 20,
        assignedStaff: ["staff1"],
        feedback: "Great Indian food!",
      },
      {
        customerName: customerD.name,
        restaurant: firstRestaurant.name,
        rest_id: firstRestaurant._id,
        table_id: "T7",
        dishes: [dishes[2]._id, dishes[16]._id],
        totalAmount: 520,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "07",
        date: daysAgo(12),
        rating: 4.0,
        orderTime: new Date(daysAgo(12).setHours(14, 0, 0, 0)),
        completionTime: new Date(daysAgo(12).setHours(14, 18, 0, 0)),
        estimatedTime: 15,
        assignedStaff: ["staff1"],
        feedback: "Biryani was fragrant and tasty",
      },
    ];

    // --- customer5: Pizza & Italian lover at Urban Eats ---
    const customer5Orders = [
      {
        customerName: customerE.name,
        restaurant: urbanEats.name,
        rest_id: urbanEats._id,
        table_id: "T4",
        dishes: [dishes[11]._id, dishes[28]._id, dishes[29]._id],
        totalAmount: 880,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "04",
        date: daysAgo(1),
        rating: 5.0,
        orderTime: new Date(daysAgo(1).setHours(12, 0, 0, 0)),
        completionTime: new Date(daysAgo(1).setHours(12, 25, 0, 0)),
        estimatedTime: 22,
        assignedStaff: ["staff7"],
        feedback: "Pizza and pasta combo is heavenly!",
      },
      {
        customerName: customerE.name,
        restaurant: urbanEats.name,
        rest_id: urbanEats._id,
        table_id: "T5",
        dishes: [dishes[11]._id, dishes[12]._id],
        totalAmount: 500,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "05",
        date: daysAgo(6),
        rating: 4.5,
        orderTime: new Date(daysAgo(6).setHours(13, 15, 0, 0)),
        completionTime: new Date(daysAgo(6).setHours(13, 35, 0, 0)),
        estimatedTime: 18,
        assignedStaff: ["staff7"],
        feedback: "Consistent quality, love it",
      },
      {
        customerName: customerE.name,
        restaurant: urbanEats.name,
        rest_id: urbanEats._id,
        table_id: "T6",
        dishes: [dishes[28]._id, dishes[29]._id],
        totalAmount: 560,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "06",
        date: daysAgo(14),
        rating: 4.0,
        orderTime: new Date(daysAgo(14).setHours(19, 0, 0, 0)),
        completionTime: new Date(daysAgo(14).setHours(19, 20, 0, 0)),
        estimatedTime: 15,
        assignedStaff: ["staff7"],
        feedback: "Pasta was creamy, burger was juicy",
      },
      {
        customerName: customerE.name,
        restaurant: cozyCorner.name,
        rest_id: cozyCorner._id,
        table_id: "T3",
        dishes: [dishes[30]._id, dishes[31]._id, dishes[5]._id],
        totalAmount: 470,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "03",
        date: daysAgo(10),
        rating: 4.5,
        orderTime: new Date(daysAgo(10).setHours(10, 30, 0, 0)),
        completionTime: new Date(daysAgo(10).setHours(10, 45, 0, 0)),
        estimatedTime: 12,
        assignedStaff: ["staff8"],
        feedback: "Perfect breakfast spot",
      },
    ];

    // --- customer6: Seafood lover at Ocean Breeze ---
    const customer6Orders = [
      {
        customerName: customerF.name,
        restaurant: oceanBreeze.name,
        rest_id: oceanBreeze._id,
        table_id: "T4",
        dishes: [dishes[24]._id, dishes[25]._id, dishes[9]._id],
        totalAmount: 1450,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "04",
        date: daysAgo(3),
        rating: 5.0,
        orderTime: new Date(daysAgo(3).setHours(19, 30, 0, 0)),
        completionTime: new Date(daysAgo(3).setHours(20, 5, 0, 0)),
        estimatedTime: 30,
        assignedStaff: ["staff5"],
        feedback: "Seafood platter was outstanding!",
      },
      {
        customerName: customerF.name,
        restaurant: oceanBreeze.name,
        rest_id: oceanBreeze._id,
        table_id: "T5",
        dishes: [dishes[24]._id, dishes[3]._id],
        totalAmount: 880,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "05",
        date: daysAgo(9),
        rating: 4.5,
        orderTime: new Date(daysAgo(9).setHours(20, 0, 0, 0)),
        completionTime: new Date(daysAgo(9).setHours(20, 30, 0, 0)),
        estimatedTime: 25,
        assignedStaff: ["staff5"],
        feedback: "Crab curry was full of flavor",
      },
      {
        customerName: customerF.name,
        restaurant: oceanBreeze.name,
        rest_id: oceanBreeze._id,
        table_id: "T6",
        dishes: [dishes[25]._id, dishes[53]._id],
        totalAmount: 1000,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "06",
        date: daysAgo(18),
        rating: 5.0,
        orderTime: new Date(daysAgo(18).setHours(19, 0, 0, 0)),
        completionTime: new Date(daysAgo(18).setHours(19, 40, 0, 0)),
        estimatedTime: 35,
        assignedStaff: ["staff5"],
        feedback: "Lobster and shrimp scampi - pure luxury",
      },
      {
        customerName: customerF.name,
        restaurant: spiceHub.name,
        ...
        date: daysAgo(7),
        rating: 4.0,
        orderTime: new Date(daysAgo(7).setHours(13, 0, 0, 0)),
        completionTime: new Date(daysAgo(7).setHours(13, 22, 0, 0)),
        estimatedTime: 18,
        assignedStaff: ["staff2"],
        feedback: "Butter chicken was tasty",
      },
    ];

    // --- customer7: Chinese/Indo-Chinese lover at The Spice Route ---
    const customer7Orders = [
      {
        customerName: customerG.name,
        restaurant: spiceRoute.name,
        rest_id: spiceRoute._id,
        table_id: "T4",
        dishes: [dishes[32]._id, dishes[33]._id, dishes[46]._id],
        totalAmount: 480,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "04",
        date: daysAgo(2),
        rating: 5.0,
        orderTime: new Date(daysAgo(2).setHours(13, 0, 0, 0)),
        completionTime: new Date(daysAgo(2).setHours(13, 18, 0, 0)),
        estimatedTime: 15,
        assignedStaff: ["staff9"],
        feedback: "Best indo-chinese in town!",
      },
      {
        customerName: customerG.name,
        restaurant: spiceRoute.name,
        rest_id: spiceRoute._id,
        table_id: "T5",
        dishes: [dishes[32]._id, dishes[47]._id],
        totalAmount: 340,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "05",
        date: daysAgo(11),
        rating: 4.5,
        orderTime: new Date(daysAgo(11).setHours(19, 30, 0, 0)),
        completionTime: new Date(daysAgo(11).setHours(19, 48, 0, 0)),
        estimatedTime: 15,
        assignedStaff: ["staff9"],
        feedback: "Manchurian and momos are a great combo",
      },
      {
        customerName: customerG.name,
        restaurant: spiceRoute.name,
        rest_id: spiceRoute._id,
        table_id: "T6",
        dishes: [dishes[33]._id, dishes[13]._id, dishes[44]._id],
        totalAmount: 470,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "06",
        date: daysAgo(20),
        rating: 4.0,
        orderTime: new Date(daysAgo(20).setHours(14, 0, 0, 0)),
        completionTime: new Date(daysAgo(20).setHours(14, 20, 0, 0)),
        estimatedTime: 18,
        assignedStaff: ["staff9"],
        feedback: "Noodles and fried rice combo was filling",
      },
      {
        customerName: customerG.name,
        restaurant: gardenFresh.name,
        rest_id: gardenFresh._id,
        table_id: "T3",
        dishes: [dishes[15]._id, dishes[34]._id, dishes[35]._id],
        totalAmount: 510,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "03",
        date: daysAgo(4),
        rating: 4.5,
        orderTime: new Date(daysAgo(4).setHours(11, 0, 0, 0)),
        completionTime: new Date(daysAgo(4).setHours(11, 18, 0, 0)),
        estimatedTime: 15,
        assignedStaff: ["staff10"],
        feedback: "Healthy and delicious options",
      },
    ];

    // --- customer8: Mexican food lover at Spicy Fiesta ---
    const customer8Orders = [
      {
        customerName: customerH.name,
        restaurant: spicyFiesta.name,
        rest_id: spicyFiesta._id,
        table_id: "T3",
        dishes: [dishes[10]._id, dishes[26]._id, dishes[27]._id],
        totalAmount: 730,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "03",
        date: daysAgo(1),
        rating: 5.0,
        orderTime: new Date(daysAgo(1).setHours(13, 0, 0, 0)),
        completionTime: new Date(daysAgo(1).setHours(13, 15, 0, 0)),
        estimatedTime: 12,
        assignedStaff: ["staff6"],
        feedback: "Mexican trio is the best value meal!",
      },
      {
        customerName: customerH.name,
        restaurant: spicyFiesta.name,
        rest_id: spicyFiesta._id,
        table_id: "T4",
        dishes: [dishes[26]._id, dishes[27]._id],
        totalAmount: 530,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "04",
        date: daysAgo(8),
        rating: 4.5,
        orderTime: new Date(daysAgo(8).setHours(19, 0, 0, 0)),
        completionTime: new Date(daysAgo(8).setHours(19, 12, 0, 0)),
        estimatedTime: 10,
        assignedStaff: ["staff6"],
        feedback: "Quesadilla and burrito are a must-try",
      },
      {
        customerName: customerH.name,
        restaurant: spicyFiesta.name,
        rest_id: spicyFiesta._id,
        table_id: "T5",
        dishes: [dishes[10]._id, dishes[55]._id],
        totalAmount: 420,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "05",
        date: daysAgo(16),
        rating: 4.0,
        orderTime: new Date(daysAgo(16).setHours(12, 30, 0, 0)),
        completionTime: new Date(daysAgo(16).setHours(12, 42, 0, 0)),
        estimatedTime: 10,
        assignedStaff: ["staff6"],
        feedback: "Tacos and falafel wrap - great fusion",
      },
      {
        customerName: customerH.name,
        restaurant: greenGarden.name,
        rest_id: greenGarden._id,
        table_id: "T4",
        dishes: [dishes[22]._id, dishes[15]._id, dishes[23]._id],
        totalAmount: 550,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "04",
        date: daysAgo(6),
        rating: 4.5,
        orderTime: new Date(daysAgo(6).setHours(11, 30, 0, 0)),
        completionTime: new Date(daysAgo(6).setHours(11, 48, 0, 0)),
        estimatedTime: 15,
        assignedStaff: ["staff4"],
        feedback: "Vegan options are impressive",
      },
      {
        customerName: customerH.name,
        restaurant: greenGarden.name,
        ...
        date: daysAgo(13),
        rating: 4.0,
        orderTime: new Date(daysAgo(13).setHours(14, 0, 0, 0)),
        completionTime: new Date(daysAgo(13).setHours(14, 20, 0, 0)),
        estimatedTime: 18,
        assignedStaff: ["staff4"],
        feedback: "Classic Indian dishes done well",
      },
    ];

    // ═══════════════════════════════════════════
    // HISTORICAL ORDERS (previous months for trend comparison)
    // ═══════════════════════════════════════════
    const historicalOrders = [
      // ---------- 35-40 days ago (previous month) ----------
      {
        customerName: customerA.name,
        restaurant: firstRestaurant.name,
        rest_id: firstRestaurant._id,
        ...
        date: daysAgo(35),
        rating: 4.5,
        orderTime: new Date(daysAgo(35).setHours(12, 0, 0, 0)),
        completionTime: new Date(daysAgo(35).setHours(12, 20, 0, 0)),
        estimatedTime: 18,
        assignedStaff: ["staff1"],
      ...
      },
      {
        ...
        rest_id: firstRestaurant._id,
        table_id: "T2",
        dishes: [dishes[1]._id, dishes[6]._id],
        totalAmount: 630,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "02",
        date: daysAgo(38),
        rating: 4.0,
        orderTime: new Date(daysAgo(38).setHours(13, 0, 0, 0)),
        completionTime: new Date(daysAgo(38).setHours(13, 15, 0, 0)),
        estimatedTime: 12,
        assignedStaff: ["staff1"],
        feedback: "Good curries",
      },
      {
        customerName: customerC.name,
        restaurant: spiceHub.name,
        rest_id: spiceHub._id,
        table_id: "T1",
        dishes: [dishes[3]._id, dishes[4]._id, dishes[7]._id],
        totalAmount: 1230,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "01",
        date: daysAgo(36),
        rating: 5.0,
        orderTime: new Date(daysAgo(36).setHours(19, 0, 0, 0)),
        completionTime: new Date(daysAgo(36).setHours(19, 30, 0, 0)),
        estimatedTime: 25,
        assignedStaff: ["staff2"],
        feedback: "Excellent non-veg platter",
      },
      {
        customerName: customerA.name,
        restaurant: southDelight.name,
        rest_id: southDelight._id,
        table_id: "T1",
        dishes: [dishes[5]._id, dishes[8]._id, dishes[20]._id],
        totalAmount: 370,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "01",
        date: daysAgo(37),
        rating: 4.5,
        orderTime: new Date(daysAgo(37).setHours(8, 0, 0, 0)),
        completionTime: new Date(daysAgo(37).setHours(8, 12, 0, 0)),
        estimatedTime: 10,
        assignedStaff: ["staff3"],
        feedback: "Perfect South Indian breakfast",
      },
      {
        customerName: customerD.name,
        restaurant: sunsetGrill.name,
        ...
        date: daysAgo(40),
        rating: 5.0,
        orderTime: new Date(daysAgo(40).setHours(19, 0, 0, 0)),
        completionTime: new Date(daysAgo(40).setHours(19, 35, 0, 0)),
        estimatedTime: 30,
        assignedStaff: ["staff11"],
        feedback: "BBQ heaven!",
      },
      {
        ...
        date: daysAgo(39),
        rating: 4.5,
        orderTime: new Date(daysAgo(39).setHours(12, 30, 0, 0)),
        completionTime: new Date(daysAgo(39).setHours(12, 50, 0, 0)),
        estimatedTime: 18,
        assignedStaff: ["staff7"],
        feedback: "Pizza and pasta never disappoint",
      },
      {
        customerName: customerF.name,
        restaurant: oceanBreeze.name,
        rest_id: oceanBreeze._id,
        table_id: "T1",
        dishes: [dishes[24]._id, dishes[9]._id],
        totalAmount: 900,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "01",
        date: daysAgo(36),
        rating: 4.5,
        orderTime: new Date(daysAgo(36).setHours(20, 0, 0, 0)),
        completionTime: new Date(daysAgo(36).setHours(20, 25, 0, 0)),
        estimatedTime: 22,
        assignedStaff: ["staff5"],
        feedback: "Seafood was fresh and flavorful",
      },
      {
        customerName: customerG.name,
        restaurant: spiceRoute.name,
        ...
        date: daysAgo(38),
        rating: 4.0,
        orderTime: new Date(daysAgo(38).setHours(13, 30, 0, 0)),
        completionTime: new Date(daysAgo(38).setHours(13, 45, 0, 0)),
        estimatedTime: 12,
        assignedStaff: ["staff9"],
        feedback: "Indo-Chinese is good here",
      },
      {
        customerName: customerH.name,
        restaurant: spicyFiesta.name,
        ...
        date: daysAgo(37),
        rating: 4.5,
        orderTime: new Date(daysAgo(37).setHours(13, 0, 0, 0)),
        completionTime: new Date(daysAgo(37).setHours(13, 12, 0, 0)),
        estimatedTime: 10,
        assignedStaff: ["staff6"],
        feedback: "Tacos and quesadilla are my go-to",
      },
      {
        customerName: customerB.name,
        restaurant: greenGarden.name,
        rest_id: greenGarden._id,
        table_id: "T1",
        dishes: [dishes[22]._id, dishes[23]._id],
        totalAmount: 400,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "01",
        date: daysAgo(40),
        rating: 4.0,
        orderTime: new Date(daysAgo(40).setHours(11, 0, 0, 0)),
        completionTime: new Date(daysAgo(40).setHours(11, 15, 0, 0)),
        estimatedTime: 12,
        assignedStaff: ["staff4"],
        feedback: "Healthy vegan options",
      },
      {
        customerName: customerA.name,
        restaurant: cozyCorner.name,
        ...
        date: daysAgo(42),
        rating: 4.5,
        orderTime: new Date(daysAgo(42).setHours(9, 0, 0, 0)),
        completionTime: new Date(daysAgo(42).setHours(9, 12, 0, 0)),
        estimatedTime: 10,
        assignedStaff: ["staff8"],
        feedback: "Best cafe in town",
      },
      {
        customerName: customerC.name,
        restaurant: gardenFresh.name,
        rest_id: gardenFresh._id,
        table_id: "T1",
        dishes: [dishes[35]._id, dishes[34]._id],
        totalAmount: 360,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "01",
        date: daysAgo(41),
        rating: 5.0,
        orderTime: new Date(daysAgo(41).setHours(12, 0, 0, 0)),
        completionTime: new Date(daysAgo(41).setHours(12, 15, 0, 0)),
        estimatedTime: 12,
        assignedStaff: ["staff10"],
        feedback: "Buddha bowl is simply the best",
      },
      // ---------- 60-75 days ago (2 months back) ----------
      {
        customerName: customerA.name,
        restaurant: firstRestaurant.name,
        rest_id: firstRestaurant._id,
        ...
        date: daysAgo(62),
        rating: 4.0,
        orderTime: new Date(daysAgo(62).setHours(12, 0, 0, 0)),
        completionTime: new Date(daysAgo(62).setHours(12, 15, 0, 0)),
        estimatedTime: 12,
        assignedStaff: ["staff1"],
        feedback: "Good paneer tikka",
      },
      {
        customerName: customerD.name,
        restaurant: sunsetGrill.name,
        ...
        date: daysAgo(65),
        rating: 5.0,
        orderTime: new Date(daysAgo(65).setHours(20, 0, 0, 0)),
        completionTime: new Date(daysAgo(65).setHours(20, 30, 0, 0)),
        estimatedTime: 25,
        assignedStaff: ["staff11"],
        feedback: "Ribs are top notch",
      },
      {
        customerName: customerE.name,
        restaurant: urbanEats.name,
        ...
        date: daysAgo(68),
        rating: 4.0,
        orderTime: new Date(daysAgo(68).setHours(13, 0, 0, 0)),
        completionTime: new Date(daysAgo(68).setHours(13, 20, 0, 0)),
        estimatedTime: 15,
        assignedStaff: ["staff7"],
        feedback: "Nice margherita",
      },
      {
        customerName: customerF.name,
        restaurant: oceanBreeze.name,
        rest_id: oceanBreeze._id,
        table_id: "T2",
        dishes: [dishes[25]._id, dishes[3]._id],
        totalAmount: 950,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "02",
        date: daysAgo(70),
        rating: 4.5,
        orderTime: new Date(daysAgo(70).setHours(19, 0, 0, 0)),
        completionTime: new Date(daysAgo(70).setHours(19, 35, 0, 0)),
        estimatedTime: 28,
        assignedStaff: ["staff5"],
        feedback: "Lobster is always a treat",
      },
      {
        customerName: customerB.name,
        restaurant: spiceHub.name,
        ...
        date: daysAgo(72),
        rating: 4.5,
        orderTime: new Date(daysAgo(72).setHours(14, 0, 0, 0)),
        completionTime: new Date(daysAgo(72).setHours(14, 25, 0, 0)),
        estimatedTime: 20,
        assignedStaff: ["staff2"],
        feedback: "Biryani combo was superb",
      },
      {
        customerName: customerG.name,
        restaurant: spiceRoute.name,
        rest_id: spiceRoute._id,
        table_id: "T2",
        dishes: [dishes[45]._id, dishes[46]._id],
        totalAmount: 260,
        status: "completed",
        paymentStatus: "paid",
        tableNumber: "02",
        date: daysAgo(67),
        rating: 4.0,
        orderTime: new Date(daysAgo(67).setHours(18, 0, 0, 0)),
        completionTime: new Date(daysAgo(67).setHours(18, 12, 0, 0)),
        estimatedTime: 10,
        assignedStaff: ["staff9"],
        feedback: "Soup and spring rolls good starter",
      },
      {
        customerName: customerH.name,
        restaurant: spicyFiesta.name,
        ...
        date: daysAgo(75),
        rating: 4.0,
        orderTime: new Date(daysAgo(75).setHours(12, 0, 0, 0)),
        completionTime: new Date(daysAgo(75).setHours(12, 10, 0, 0)),
        estimatedTime: 8,
        assignedStaff: ["staff6"],
        feedback: "Burrito is always reliable",
      },
    ];
    ...
    console.log("  Password: 123456");
    console.log("\nCustomers:");
    console.log("  Username: customer1 - customer8");
    console.log("  Password: 123456");
